...
<div class="row">
    <?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-md-3">
            <div class="card">
                <img src="http://localhost:8000/<?php echo e($relatedProduct['image']); ?>" class="card-img-top" alt="<?php echo e($relatedProduct['name']); ?>">
                <div class="card-body">
                    <h5 class="card-title"><?php echo e($relatedProduct['name']); ?></h5>
                    <p class="card-text"><?php echo e(number_format($relatedProduct['price'], 0, ',', '.')); ?> đ</p>
                    <a href="/products/detail/<?php echo e($relatedProduct['id']); ?>" class="btn btn-primary">Xem chi tiết</a>
                </div>
            </div>
        </div>
